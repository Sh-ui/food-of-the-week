...
- Frozen mire poix has been vacuum sealed and stored in the freezer.
...
Preheat oven to 500°F. On a large sheet pan (don't overcrowd), arrange: frozen tilapia fillets, cherry tomatoes (whole), red onion cut into thick wedges. Scatter olives around.

Season everything generously: drizzle with olive oil, add harissa paste, salt, and pepper. Add thin slices of fresh lemon wedges tucked around the pan.

Roast for around 15 minutes until tilapia is cooked through and tomatoes are bursting. The fish should flake easily and have golden edges (Z can poke test it?)
